...
var TOOL_PROFILES = {
    ...
    code:        { description: 'GitHub repo work: clone/browse/read/edit/diff via workspace, run the test suite via run_tests', tools: ['workspace', 'web_fetch', 'run_js_file', 'run_tests'] },
    'extension-dev': { description: 'AppAgent extension development: the code tools (workspace, web_fetch, run_tests) + runtime_inspect and screenshots', tools: ['workspace', 'web_fetch', 'run_js_file', 'run_tests', 'runtime_inspect', 'take_screenshot', 'screenshot_by_id'] },
